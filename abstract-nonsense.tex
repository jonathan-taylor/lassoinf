...
To see this, let's assuming for simplicity $\mu=0$ below so we can write $\E$ instead of $\Cov$.
...
\cite{RFG} for counting critical points of a real-valued function is the $\cH$ connection. For counting
