...
\begin{document}
	...
	\end{equation*}
	where $JV_{{\tt t}}$ is the Jacobian of $V_{{\tt t}}$, a block diagonal matrix with blocks $\nabla^2 Y_t$ and $\nabla^2 Y_{t'}$. Under \ag{appropriate smoothness and non-degeneracy conditions}, the \emph{Kac-Rice theorem} gives a formula for $\E[N_{(u,v)}(A,B)]$:
	\begin{equation}
		\begin{aligned}
	...
	\section{Proof of Theorem~\ref{thm:approximate-randomized-joint-intensity}}
